...
### 1.2 成功标准
- [ ] `UploadSourceSelectDialog.js` 组件创建完成
- [ ] 点击"选择文件"按钮时弹出上传源选择对话框
- [ ] 对话框包含"本地文件"和"OBS文件"两个选项
- [ ] 选择"本地文件"触发原有的本地文件选择逻辑
- [ ] 选择"OBS文件"打开OBS文件浏览器(TASK-003)
- [ ] UI样式符合Material-UI设计规范
- [ ] 对话框支持取消操作
- [ ] 代码遵循代码隔离原则(在custom目录,使用CUSTOM标记)
...
### 6.1 代码文件
- [ ] `components/custom/obs/UploadSourceSelectDialog.js` - 上传源选择对话框
- [ ] `components/text-split/components/UploadArea.js` - 修改(添加CUSTOM标记)

### 6.2 文档文件
- [ ] 更新本TASK文档(记录实际执行情况)
- [ ] 更新tasks/README.md(标记任务完成)
- [ ] 更新00-PROJECT-STATUS.md(更新项目进度)
...
**任务状态**: 待开始
**下一步**: 阅读UploadArea.js代码,创建UploadSourceSelectDialog组件
**更新时间**: 2025-11-10
