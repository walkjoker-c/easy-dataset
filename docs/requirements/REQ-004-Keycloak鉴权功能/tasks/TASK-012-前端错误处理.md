...
- [ ] 403错误: 显示"无权访问"错误页面或提示
- [ ] 503错误: 显示"系统错误"提示 (Keycloak不可用)
- [ ] 使用项目现有UI组件 (Material-UI)
- [ ] 可选: 实现全局错误边界组件 (Error Boundary)
- [ ] 测试各种错误场景的展示效果
...
- [x] lib/custom/utils/errorHandler.js (新增文件,约80行代码,可选)
- [x] app/error.js (新增文件,约60行代码,可选)
- [x] 在现有组件中添加错误处理逻辑 (修改)
