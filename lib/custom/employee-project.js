...
// 修改日期: 2025-11-18 | 需求: REQ-004 - 支持createdByUserId参数
 ...
 * @param {string} [data.createdByUserId] - 创建者用户ID(可选) - REQ-004
 * @returns {Promise<Project>}
 */
export async function createProjectWithExternalId(data) {
  const { externalId, name, description, createdByUserId } = data;
  ...
  // 变更说明: 更新项目时设置externalId和createdByUserId
