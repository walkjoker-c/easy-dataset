...
//   4. 详细的警告日志,便于追踪数据质量
// 使用说明: 此文件仅导出增强函数,请通过 questions-facade.js 统一导入
// ========== CUSTOM FILE ==========
 ...
 */
export async function saveQuestionsEnhanced(projectId, questions, chunkId) {
  try {
 ...
 * @returns {Promise<Array>} - 保存后的问题列表
 */
export async function saveQuestionsWithGaPairEnhanced(projectId, questions, chunkId, gaPairId = null) {
  try {
    if (!questions || !Array.isArray(questions)) {
